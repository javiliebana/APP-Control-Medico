...
public class SQL_conexion {
	 ...
	 * y el statement para par�metros
	 * @param cquerySQL
	 */
	...
	//#######################
	public SQL_conexion() {
		this.setConnection();  // abrimos la conexi�n
	}
	...
	/**=====================================================================
	 * m�todo p�blico SQL_conexion conexi�n al driver mySQL a bbdd localhost 
	 * @return booleano de conexi�n OK/KO
	 =====================================================================*/
	private boolean setConnection() {
		try {
			...
			conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/rcp","root", "");
			return true;
